...
print('Number of elements', len(elements_to_operate)-1)
#- їхню суму
...
print('Кiлькiсть елементiв дорівнюють найбільшому елементу: ', max(elements_to_operate))
